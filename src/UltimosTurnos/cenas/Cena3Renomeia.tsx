    ...
    >
      ...
      <Interactive.Div
        ...
        style={{
          ...
          fontSize: 40,
          fontWeight: 500,
          opacity: interpolate(frame, [92, 113], [0, 1], {
            extrapolateLeft: "clamp",
            extrapolateRight: "clamp",
            easing: Easing.bezier(0.16, 1, 0.3, 1),
          }),
      ...
      <Interactive.Div
        ...
        style={{
          ...
          whiteSpace: "nowrap",
          rotate: "-3deg",
          scale: interpolate(frame, [141, 169], [0.7, 1], {
            extrapolateLeft: "clamp",
            extrapolateRight: "clamp",
            easing: Easing.spring({ damping: 12 }),
            output: "perceptual-scale",
          }),
          opacity: interpolate(frame, [141, 159], [0, 1], {
            extrapolateLeft: "clamp",
            extrapolateRight: "clamp",
            easing: Easing.bezier(0.16, 1, 0.3, 1),
          }),
